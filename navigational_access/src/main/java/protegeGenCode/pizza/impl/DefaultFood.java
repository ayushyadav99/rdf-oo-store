 ...
 * Source Class: DefaultFood <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFood extends WrappedIndividualImpl implements Food , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultFood(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
