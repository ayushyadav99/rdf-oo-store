 ...
 * Source Class: DefaultAnchoviesTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultAnchoviesTopping extends WrappedIndividualImpl implements AnchoviesTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultAnchoviesTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
