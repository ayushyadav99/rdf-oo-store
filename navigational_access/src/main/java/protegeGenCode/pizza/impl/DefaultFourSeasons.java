 ...
 * Source Class: DefaultFourSeasons <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFourSeasons extends WrappedIndividualImpl implements FourSeasons , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultFourSeasons(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
