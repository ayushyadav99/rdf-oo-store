 ...
 * Source Class: DefaultGorgonzolaTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultGorgonzolaTopping extends WrappedIndividualImpl implements GorgonzolaTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultGorgonzolaTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
