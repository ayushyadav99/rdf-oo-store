 ...
 * Source Class: DefaultHotGreenPepperTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultHotGreenPepperTopping extends WrappedIndividualImpl implements HotGreenPepperTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultHotGreenPepperTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
