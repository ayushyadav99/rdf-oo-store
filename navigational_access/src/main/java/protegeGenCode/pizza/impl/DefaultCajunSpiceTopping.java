 ...
 * Source Class: DefaultCajunSpiceTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultCajunSpiceTopping extends WrappedIndividualImpl implements CajunSpiceTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultCajunSpiceTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
