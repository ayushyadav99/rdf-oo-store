 ...
 * Source Class: DefaultPetitPoisTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPetitPoisTopping extends WrappedIndividualImpl implements PetitPoisTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultPetitPoisTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
