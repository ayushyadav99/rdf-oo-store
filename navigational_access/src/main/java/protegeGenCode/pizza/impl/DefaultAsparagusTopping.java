 ...
 * Source Class: DefaultAsparagusTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultAsparagusTopping extends WrappedIndividualImpl implements AsparagusTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultAsparagusTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
