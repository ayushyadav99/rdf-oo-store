 ...
 * Source Class: DefaultCheeseTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultCheeseTopping extends WrappedIndividualImpl implements CheeseTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultCheeseTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
