 ...
 * Source Class: DefaultHerbSpiceTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultHerbSpiceTopping extends WrappedIndividualImpl implements HerbSpiceTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultHerbSpiceTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
