 ...
 * Source Class: DefaultFruttiDiMare <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFruttiDiMare extends WrappedIndividualImpl implements FruttiDiMare , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultFruttiDiMare(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
