 ...
 * Source Class: DefaultPrinceCarlo <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPrinceCarlo extends WrappedIndividualImpl implements PrinceCarlo , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultPrinceCarlo(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
