 ...
 * Source Class: DefaultPineKernelTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPineKernelTopping extends WrappedIndividualImpl implements PineKernelTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultPineKernelTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
