 ...
 * Source Class: DefaultSlicedTomatoTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSlicedTomatoTopping extends WrappedIndividualImpl implements SlicedTomatoTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultSlicedTomatoTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
