 ...
 * Source Class: DefaultDestination <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultDestination extends WrappedIndividualImpl implements Destination , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultDestination(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
