 ...
 * Source Class: DefaultBunjeeJumping <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultBunjeeJumping extends WrappedIndividualImpl implements BunjeeJumping , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultBunjeeJumping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
