 ...
 * Source Class: DefaultSafari <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSafari extends WrappedIndividualImpl implements Safari , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultSafari(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
