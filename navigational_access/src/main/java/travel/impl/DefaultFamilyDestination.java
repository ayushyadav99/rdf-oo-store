 ...
 * Source Class: DefaultFamilyDestination <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFamilyDestination extends WrappedIndividualImpl implements FamilyDestination , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultFamilyDestination(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
