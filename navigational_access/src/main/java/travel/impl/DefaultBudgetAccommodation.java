 ...
 * Source Class: DefaultBudgetAccommodation <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultBudgetAccommodation extends WrappedIndividualImpl implements BudgetAccommodation , Serializable {
...
private Collection < ? extends AccommodationRating > HasRating ;
    ...
    public DefaultBudgetAccommodation(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
