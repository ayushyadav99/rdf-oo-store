 ...
 * Source Class: DefaultSports <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSports extends WrappedIndividualImpl implements Sports , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultSports(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
