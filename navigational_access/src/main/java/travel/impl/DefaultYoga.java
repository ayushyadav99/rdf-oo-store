 ...
 * Source Class: DefaultYoga <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultYoga extends WrappedIndividualImpl implements Yoga , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultYoga(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
