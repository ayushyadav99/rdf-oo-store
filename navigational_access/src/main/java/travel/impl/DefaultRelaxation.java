 ...
 * Source Class: DefaultRelaxation <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultRelaxation extends WrappedIndividualImpl implements Relaxation , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultRelaxation(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
