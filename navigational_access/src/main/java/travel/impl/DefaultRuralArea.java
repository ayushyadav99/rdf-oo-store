 ...
 * Source Class: DefaultRuralArea <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultRuralArea extends WrappedIndividualImpl implements RuralArea , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultRuralArea(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
