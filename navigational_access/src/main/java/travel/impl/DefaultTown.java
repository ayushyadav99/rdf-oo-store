 ...
 * Source Class: DefaultTown <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultTown extends WrappedIndividualImpl implements Town , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultTown(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
