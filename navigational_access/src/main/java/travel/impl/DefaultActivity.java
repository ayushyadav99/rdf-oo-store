 ...
 */
@Entity
 public class DefaultActivity extends WrappedIndividualImpl implements Activity , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultActivity(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
