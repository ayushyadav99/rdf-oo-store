 ...
 * Source Class: DefaultBeach <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultBeach extends WrappedIndividualImpl implements Beach , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultBeach(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
