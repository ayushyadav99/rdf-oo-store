 ...
 * Source Class: DefaultNationalPark <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultNationalPark extends WrappedIndividualImpl implements NationalPark , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultNationalPark(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
