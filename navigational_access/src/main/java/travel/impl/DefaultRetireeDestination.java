 ...
 * Source Class: DefaultRetireeDestination <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultRetireeDestination extends WrappedIndividualImpl implements RetireeDestination , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultRetireeDestination(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
