 ...
 * Source Class: DefaultFarmland <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFarmland extends WrappedIndividualImpl implements Farmland , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultFarmland(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
