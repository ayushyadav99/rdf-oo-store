 ...
 * Source Class: DefaultCampground <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultCampground extends WrappedIndividualImpl implements Campground , Serializable {
...
private Collection < ? extends AccommodationRating > HasRating ;
    ...
    public DefaultCampground(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
