 ...
 * Source Class: DefaultQuietDestination <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultQuietDestination extends WrappedIndividualImpl implements QuietDestination , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultQuietDestination(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
