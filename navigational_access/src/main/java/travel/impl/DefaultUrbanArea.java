 ...
 * Source Class: DefaultUrbanArea <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultUrbanArea extends WrappedIndividualImpl implements UrbanArea , Serializable {
...
private Collection < ? extends Destination > HasPart ;
    ...
    public DefaultUrbanArea(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
