 ...
 * Source Class: DefaultLuxuryHotel <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultLuxuryHotel extends WrappedIndividualImpl implements LuxuryHotel , Serializable {
...
private Collection < ? extends AccommodationRating > HasRating ;
    ...
    public DefaultLuxuryHotel(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
