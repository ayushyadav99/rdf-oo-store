 ...
 * Source Class: DefaultSightseeing <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSightseeing extends WrappedIndividualImpl implements Sightseeing , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultSightseeing(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
