 ...
 * Source Class: DefaultAccommodation <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultAccommodation extends WrappedIndividualImpl implements Accommodation , Serializable {
...
private Collection < ? extends AccommodationRating > HasRating ;
    ...
    public DefaultAccommodation(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
