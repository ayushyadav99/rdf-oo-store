 ...
 * Source Class: DefaultAdventure <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultAdventure extends WrappedIndividualImpl implements Adventure , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultAdventure(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
