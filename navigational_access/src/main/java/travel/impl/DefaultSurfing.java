 ...
 * Source Class: DefaultSurfing <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSurfing extends WrappedIndividualImpl implements Surfing , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultSurfing(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
