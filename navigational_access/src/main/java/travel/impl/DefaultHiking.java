 ...
 * Source Class: DefaultHiking <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultHiking extends WrappedIndividualImpl implements Hiking , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultHiking(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
