 ...
 * Source Class: DefaultMuseums <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultMuseums extends WrappedIndividualImpl implements Museums , Serializable {
...
private Collection < ? extends Destination > IsOfferedAt ;
    ...
    public DefaultMuseums(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
