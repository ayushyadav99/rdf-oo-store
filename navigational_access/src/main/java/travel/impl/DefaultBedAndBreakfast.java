 ...
 * Source Class: DefaultBedAndBreakfast <br>
 * @version generated on Sun May 16 18:22:29 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultBedAndBreakfast extends WrappedIndividualImpl implements BedAndBreakfast , Serializable {
...
private Collection < ? extends AccommodationRating > HasRating ;
    ...
    public DefaultBedAndBreakfast(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
