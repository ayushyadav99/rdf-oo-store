 ...
 * Source Class: DefaultLarge_Format <br>
 * @version generated on Sun May 16 18:13:09 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultLarge_Format extends WrappedIndividualImpl implements Large_Format , Serializable {
...
private Collection < ? extends Viewer > ViewFinder ;
    ...
    public DefaultLarge_Format(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
