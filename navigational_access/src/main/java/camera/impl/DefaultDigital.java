 ...
 * Source Class: DefaultDigital <br>
 * @version generated on Sun May 16 18:13:09 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultDigital extends WrappedIndividualImpl implements Digital , Serializable {
...
private Collection < ? extends Viewer > ViewFinder ;
    ...
    public DefaultDigital(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
