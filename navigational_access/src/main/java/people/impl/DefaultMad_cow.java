 ...
 * Source Class: DefaultMad_cow <br>
 * @version generated on Sun May 16 17:26:15 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultMad_cow extends WrappedIndividualImpl implements Mad_cow , Serializable {
...
private Collection < ? extends WrappedIndividual > Eats ;
    ...
    public DefaultMad_cow(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
