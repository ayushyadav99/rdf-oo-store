 ...
 * Source Class: DefaultTiger <br>
 * @version generated on Sun May 16 17:26:15 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultTiger extends WrappedIndividualImpl implements Tiger , Serializable {
...
private Collection < ? extends WrappedIndividual > Eats ;
    ...
    public DefaultTiger(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
