 ...
 * Source Class: DefaultCat <br>
 * @version generated on Sun May 16 17:26:14 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultCat extends WrappedIndividualImpl implements Cat , Serializable {
...
private Collection < ? extends WrappedIndividual > Eats ;
    ...
    public DefaultCat(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
