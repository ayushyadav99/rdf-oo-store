 ...
 * Source Class: DefaultCow <br>
 * @version generated on Sun May 16 17:26:14 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultCow extends WrappedIndividualImpl implements Cow , Serializable {
...
private Collection < ? extends WrappedIndividual > Eats ;
    ...
    public DefaultCow(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
