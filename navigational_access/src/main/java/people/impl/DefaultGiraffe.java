 ...
 * Source Class: DefaultGiraffe <br>
 * @version generated on Sun May 16 17:26:15 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultGiraffe extends WrappedIndividualImpl implements Giraffe , Serializable {
...
private Collection < ? extends WrappedIndividual > Eats ;
    ...
    public DefaultGiraffe(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
