 ...
 * Source Class: DefaultDuck <br>
 * @version generated on Sun May 16 17:26:15 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultDuck extends WrappedIndividualImpl implements Duck , Serializable {
...
private Collection < ? extends WrappedIndividual > Eats ;
    ...
    public DefaultDuck(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toString();
