 ...
 * Source Class: DefaultPizzaBase <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPizzaBase extends WrappedIndividualImpl implements PizzaBase , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultPizzaBase(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
