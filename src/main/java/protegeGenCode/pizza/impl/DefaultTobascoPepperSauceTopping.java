 ...
 * Source Class: DefaultTobascoPepperSauceTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultTobascoPepperSauceTopping extends WrappedIndividualImpl implements TobascoPepperSauceTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultTobascoPepperSauceTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
