 ...
 * Source Class: DefaultVegetarianPizza2 <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultVegetarianPizza2 extends WrappedIndividualImpl implements VegetarianPizza2 , Serializable {
...
private class DefaultVe arianPizza2 extends WrappedIndividualImpl implements Ve arianPizza2 { ;
private DefaultVe arianPizza2 ; CodeGenerationInference inference, IRI iri ) { ;
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultVegetarianPizza2(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
	
	arianPizza2 getarianPizza2
	extends getextends
	WrappedIndividualImpl getWrappedIndividualImpl
	implements getimplements
	VearianPizza2 getVearianPizza2
	, get,
	Serializable getSerializable
	{ get{
	arianPizza2(CodeGenerationInference inference, IRI iri) getarianPizza2(CodeGenerationInference inference, IRI iri)
	{ get{
	HasBase= getHasBase();
