 ...
 * Source Class: DefaultHotSpicedBeefTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultHotSpicedBeefTopping extends WrappedIndividualImpl implements HotSpicedBeefTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultHotSpicedBeefTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
