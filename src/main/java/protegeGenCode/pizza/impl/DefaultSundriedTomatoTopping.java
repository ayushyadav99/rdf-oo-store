 ...
 * Source Class: DefaultSundriedTomatoTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSundriedTomatoTopping extends WrappedIndividualImpl implements SundriedTomatoTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultSundriedTomatoTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
