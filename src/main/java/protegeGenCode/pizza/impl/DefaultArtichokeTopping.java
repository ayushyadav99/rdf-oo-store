 ...
 * Source Class: DefaultArtichokeTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultArtichokeTopping extends WrappedIndividualImpl implements ArtichokeTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultArtichokeTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
