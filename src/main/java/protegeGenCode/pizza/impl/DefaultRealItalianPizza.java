 ...
 * Source Class: DefaultRealItalianPizza <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultRealItalianPizza extends WrappedIndividualImpl implements RealItalianPizza , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultRealItalianPizza(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
