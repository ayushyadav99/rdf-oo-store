 ...
 * Source Class: DefaultAmericanHot <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultAmericanHot extends WrappedIndividualImpl implements AmericanHot , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultAmericanHot(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
