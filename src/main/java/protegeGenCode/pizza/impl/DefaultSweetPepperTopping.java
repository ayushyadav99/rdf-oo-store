 ...
 * Source Class: DefaultSweetPepperTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSweetPepperTopping extends WrappedIndividualImpl implements SweetPepperTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultSweetPepperTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
