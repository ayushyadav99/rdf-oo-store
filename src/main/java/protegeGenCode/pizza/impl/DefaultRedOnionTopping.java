 ...
 * Source Class: DefaultRedOnionTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultRedOnionTopping extends WrappedIndividualImpl implements RedOnionTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultRedOnionTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
