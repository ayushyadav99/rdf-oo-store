 ...
 * Source Class: DefaultMushroomTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultMushroomTopping extends WrappedIndividualImpl implements MushroomTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultMushroomTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
