 ...
 * Source Class: DefaultFruitTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFruitTopping extends WrappedIndividualImpl implements FruitTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultFruitTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
