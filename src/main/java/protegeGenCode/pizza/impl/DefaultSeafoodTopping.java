 ...
 * Source Class: DefaultSeafoodTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSeafoodTopping extends WrappedIndividualImpl implements SeafoodTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultSeafoodTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
