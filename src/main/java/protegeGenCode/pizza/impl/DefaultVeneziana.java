 ...
 * Source Class: DefaultVeneziana <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultVeneziana extends WrappedIndividualImpl implements Veneziana , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultVeneziana(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
