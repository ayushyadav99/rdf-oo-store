 ...
 * Source Class: DefaultCheesyPizza <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultCheesyPizza extends WrappedIndividualImpl implements CheesyPizza , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultCheesyPizza(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
