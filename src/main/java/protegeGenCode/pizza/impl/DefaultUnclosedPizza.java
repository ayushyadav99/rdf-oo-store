 ...
 * Source Class: DefaultUnclosedPizza <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultUnclosedPizza extends WrappedIndividualImpl implements UnclosedPizza , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultUnclosedPizza(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
