 ...
 * Source Class: DefaultInterestingPizza <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultInterestingPizza extends WrappedIndividualImpl implements InterestingPizza , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultInterestingPizza(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
