 ...
 * Source Class: DefaultQuattroFormaggi <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultQuattroFormaggi extends WrappedIndividualImpl implements QuattroFormaggi , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultQuattroFormaggi(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
