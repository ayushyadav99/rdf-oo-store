 ...
 * Source Class: DefaultNapoletana <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultNapoletana extends WrappedIndividualImpl implements Napoletana , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultNapoletana(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
