 ...
 * Source Class: DefaultFourCheesesTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultFourCheesesTopping extends WrappedIndividualImpl implements FourCheesesTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultFourCheesesTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
