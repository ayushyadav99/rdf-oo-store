 ...
 * Source Class: DefaultPeperonataTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPeperonataTopping extends WrappedIndividualImpl implements PeperonataTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultPeperonataTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
