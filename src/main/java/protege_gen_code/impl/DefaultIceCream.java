 ...
 * Source Class: DefaultIceCream <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultIceCream extends WrappedIndividualImpl implements IceCream , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultIceCream(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
