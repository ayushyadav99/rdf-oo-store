 ...
 * Source Class: DefaultNamedPizza <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultNamedPizza extends WrappedIndividualImpl implements NamedPizza , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultNamedPizza(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
