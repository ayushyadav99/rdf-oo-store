 ...
 * Source Class: DefaultGreenPepperTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultGreenPepperTopping extends WrappedIndividualImpl implements GreenPepperTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultGreenPepperTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
