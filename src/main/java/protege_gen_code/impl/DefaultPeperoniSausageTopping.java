 ...
 * Source Class: DefaultPeperoniSausageTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPeperoniSausageTopping extends WrappedIndividualImpl implements PeperoniSausageTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultPeperoniSausageTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
