 ...
 * Source Class: DefaultSpicyPizzaEquivalent <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSpicyPizzaEquivalent extends WrappedIndividualImpl implements SpicyPizzaEquivalent , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultSpicyPizzaEquivalent(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
