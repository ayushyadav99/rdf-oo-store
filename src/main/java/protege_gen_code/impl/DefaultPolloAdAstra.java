 ...
 * Source Class: DefaultPolloAdAstra <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultPolloAdAstra extends WrappedIndividualImpl implements PolloAdAstra , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultPolloAdAstra(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
