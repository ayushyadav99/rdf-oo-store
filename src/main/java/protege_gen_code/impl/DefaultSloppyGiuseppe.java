 ...
 * Source Class: DefaultSloppyGiuseppe <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultSloppyGiuseppe extends WrappedIndividualImpl implements SloppyGiuseppe , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultSloppyGiuseppe(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
