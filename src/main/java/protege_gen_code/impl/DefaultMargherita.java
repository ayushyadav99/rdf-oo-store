 ...
 * Source Class: DefaultMargherita <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultMargherita extends WrappedIndividualImpl implements Margherita , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultMargherita(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
