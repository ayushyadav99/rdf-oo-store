 ...
 * Source Class: DefaultMixedSeafoodTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultMixedSeafoodTopping extends WrappedIndividualImpl implements MixedSeafoodTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultMixedSeafoodTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
