 ...
 * Source Class: DefaultGiardiniera <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultGiardiniera extends WrappedIndividualImpl implements Giardiniera , Serializable {
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultGiardiniera(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
