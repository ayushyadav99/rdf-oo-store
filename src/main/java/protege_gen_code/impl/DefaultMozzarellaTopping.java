 ...
 * Source Class: DefaultMozzarellaTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultMozzarellaTopping extends WrappedIndividualImpl implements MozzarellaTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultMozzarellaTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
