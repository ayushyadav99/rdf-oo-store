 ...
 * Source Class: DefaultParmaHamTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultParmaHamTopping extends WrappedIndividualImpl implements ParmaHamTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultParmaHamTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
