 ...
 * Source Class: DefaultVegetarianPizza <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultVegetarianPizza extends WrappedIndividualImpl implements VegetarianPizza , Serializable {
...
private class DefaultVe arianPizza extends WrappedIndividualImpl implements Ve arianPizza { ;
private DefaultVe arianPizza ; CodeGenerationInference inference, IRI iri ) { ;
...
private Collection < ? extends PizzaTopping > HasTopping ;
    ...
    public DefaultVegetarianPizza(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
	
	arianPizza getarianPizza
	extends getextends
	WrappedIndividualImpl getWrappedIndividualImpl
	implements getimplements
	VearianPizza getVearianPizza
	, get,
	Serializable getSerializable
	{ get{
	arianPizza(CodeGenerationInference inference, IRI iri) getarianPizza(CodeGenerationInference inference, IRI iri)
	{ get{
	HasBase= getHasBase();
