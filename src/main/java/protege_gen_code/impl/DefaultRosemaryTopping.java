 ...
 * Source Class: DefaultRosemaryTopping <br>
 * @version generated on Tue Apr 27 14:33:01 IST 2021 by ayushyadav
 */
@Entity
 public class DefaultRosemaryTopping extends WrappedIndividualImpl implements RosemaryTopping , Serializable {
...
private Collection < ? extends Food > HasIngredient ;
    ...
    public DefaultRosemaryTopping(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
	name = iri.toSting();
